    ...
    return [
        {
            ...
            "content": (
                ...
                "этом ходу получил имя. Впиши сюда ТОЧНО то имя, под которым он записан в "
                "списке ИЗВЕСТНЫЕ NPC — слово в слово, а не его должность. Если в списке "
                "стоит «Слуга Алисии», а сейчас его назвали Томасом, то was_called должно "
                "быть «Слуга Алисии». Это единственный способ не завести на одного человека "
                "две карточки.\n"
                "\n"
