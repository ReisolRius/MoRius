...
def _build_smart_regeneration_mode_base_lines(
    ...
    *,
    ...
    lines.extend(
        [
            "Текст отклонённого ответа намеренно не передаётся: не восстанавливай и не угадывай его тему или исход.",
            "Не делай микроправку или пересказ. Нужен реально новый вариант с самостоятельно выбранной веткой развития.",
            ...
            "",
            "Запрещено:",
            "- Пытаться угадать или восстановить отклонённый ответ.",
            "- Автоматически выбирать ту же тему или наиболее очевидный исход, если канон допускает другие ветки.",
