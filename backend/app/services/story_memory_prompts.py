    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                "If a character cannot be matched, do not return an update for that character. Return only fields "
                "that actually changed in this turn; never invent inventory changes.\n"
                ...
                "no_action. Do not create cards for crowds, unnamed extras, or the player character.\n\n"
                f"WORLD_CARD:\n{world_card or 'нет'}\n\n"
