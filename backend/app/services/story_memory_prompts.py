    ...
    return [
        {
            ...
            "content": (
                ...
                "- отдельно зафиксируй конечный якорь сцены: где она закончилась и кто физически остался рядом;\n"
                "- явно фиксируй входы, выходы, отъезды и расставания персонажей; активная карточка не означает присутствие;\n"
                "- для важной информации укажи, какой персонаж узнал её лично и откуда; не делай знание общим для всех;\n"
                "- сохрани обсуждённые планы, договорённости, маршрут и следующий ещё не выполненный шаг;\n"
                "- явно зафиксируй выполнение, провал или отмену задания/цели; такой статус закрывает прежний активный план;\n"
                ...
                "Правило против копипаста: summary должен быть сжатым пересказом, а не вставкой исходной прозы. "
                "Не переноси PLAYER_TURN или NARRATOR_RESPONSE длинными дословными кусками; допустимы только короткие ключевые фразы. "
                "Цель: 35-55% длины исходника, никогда не длиннее исходника. Не добавляй заголовки секций внутрь summary.\n\n"
                "Return JSON only. Без markdown, reasoning и комментариев."
            ),
        },
        {
            ...
            "content": (
                ...
                '  "scene_anchor": ["Конечная текущая локация и положение сцены после хода"],\n'
                '  "presence_changes": ["Кто вошёл, ушёл, остался или находится в другом месте"],\n'
                '  "character_knowledge": ["Имя персонажа знает конкретный факт, потому что увидел/услышал/ему сообщили"],\n'
                '  "active_plans": ["Кто договорился что сделать, куда идти и какой шаг ещё не выполнен"]\n'
                "}\n\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                "состояния/здоровья/одежды/инвентаря/локации/отношений/целей. Не стирай конечную локацию, "
                "уходы/отсутствие персонажей, границы их знаний и ещё не выполненные планы. "
                "Если более новый блок говорит, что миссия/цель выполнена, провалена или отменена, сохрани этот новый статус "
                "и не переноси старую миссию в active_plans/open_threads. "
                "Убери второстепенные описания и повторы. Не выдумывай, не продолжай сцену, пиши на языке исходного текста. "
        ...
        },
        {
            ...
            "content": (
                ...
                '  "scene_state": ["Последнее достоверное место и кто там присутствует/отсутствует"],\n'
                '  "character_knowledge": ["Кто знает конкретный факт и из какого источника"],\n'
                '  "active_plans": ["Незавершённая договорённость, маршрут или следующий шаг"]\n'
                "}\n\n"
    ...
    return [
        {
            ...
            "content": (
                ...
                "цели, локации, обещания, угрозы и раскрытую информацию. Сохраняй границы знаний: факт не становится "
                "известен персонажу, который не присутствовал и которому его не сообщили. Не выдумывай и не продолжай сцену. "
                "Более новый статус цели имеет приоритет: выполненная, проваленная или отменённая миссия не является "
                "active_commitment/open_thread, но факт её исхода должен сохраниться. "
                "Пиши на языке исходного текста.\n\n"
                "Return JSON only. Без markdown, reasoning и комментариев."
            ),
        },
        {
            ...
            "content": (
                ...
                '  "character_knowledge": ["Имя персонажа знает факт и источник знания"],\n'
                '  "active_commitments": ["Незавершённое обещание, договорённость, маршрут или план"]\n'
                "}\n\n"
