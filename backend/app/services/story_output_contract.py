...
def get_ai_output_contract_notes() -> list[str]:
    return [
        ...
        "Для известного персонажа в [[NPC:...]] используй точный title из его карточки без сокращений и вариантов.",
        "Для нового или непрописанного NPC перед первой репликой придумай устойчивое естественное имя и далее используй его неизменно; если имя пока нельзя раскрыть, используй до раскрытия конкретную роль длиной не более 4 слов.",
        "Имена и роли в [[NPC:...]] из предыдущих сообщений являются частью непрерывности: для того же персонажа в следующих ходах повторяй их точно.",
        "Каждая прямая речь персонажа под управлением рассказчика, включая единичный возглас, шёпот, реплику из толпы и речь за кадром, всегда начинается с [[NPC:...]]; неподписанная реплика обычным текстом запрещена.",
        "Запрещены общие обозначения говорящего: НПС, NPC, Голос, Незнакомец, Персонаж.",
