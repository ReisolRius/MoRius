...
HELP_SNIPPETS = {
    ...
    "cards": (
        "В MORU есть разные сущности. Карточки мира в конкретном мире описывают персонажей, места и факты. "
    ...
    "sols": (
        "Солы — внутренняя валюта MORU. Они списываются за AI-действия, генерацию текста и изображения. "
...
TOOL_STEP_LABELS = {
    ...
    "get_site_help": "Смотрю справку по MORU",
...
TOOL_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "function": {
            "name": "get_site_help",
            "description": "Вернуть краткую справку по работе сайта MORU.",
            "parameters": {
                "type": "object",
