...
// Shown only until /shop/plans answers; the server is the source of truth. Mirrors
// COIN_TOP_UP_PLANS in backend/app/services/payments.py.
const DEFAULT_PLANS: CoinTopUpPlan[] = [
  { id: 'standard', title: 'Путник', description: 'Один баланс для текста, изображений, рамок и баннеров.', price_rub: 399, coins: 125 },
  { id: 'pro', title: 'Искатель', description: 'Больше запаса для длинных сессий и визуальных генераций.', price_rub: 1190, coins: 400 },
  { id: 'mega', title: 'Архонт', description: 'Большой запас для активных миров, артов и покупок.', price_rub: 2990, coins: 1050 },
  { id: 'legendary', title: 'Летописец', description: 'Максимальный запас для хронистов: дорогие модели, долгие кампании.', price_rub: 5990, coins: 2150 },
]
...
const RECURRING_TERMS_PARAGRAPHS: readonly string[] = [
  'Подписка Moru — это регулярная (рекуррентная) услуга с автоматическим продлением. Оформляя подписку, вы соглашаетесь на периодическое автоматическое списание её стоимости с привязанной банковской карты.',
  ...
  'Привязка карты. Для автосписаний платёжные данные карты сохраняются на стороне платёжного провайдера ЮKassa. Moru не хранит и не обрабатывает полные реквизиты банковских карт.',
        ...
        <DialogContent>
          ...
          >
            ...
            <Stack spacing={1} sx={{ p: 2, pt: 0, alignItems: 'center', textAlign: 'center', transform: 'translateY(-34px)', mb: '-24px' }}>
              ...
              <Typography sx={{ color: 'var(--morius-title-text)', fontSize: '1.28rem', fontWeight: 950 }}>{user.display_name || 'Игрок Moru'}</Typography>
